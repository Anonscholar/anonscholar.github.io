...
\marginnote{ These definitions are superficious We have not and will not define what
...
\marginnote{ Do not be overwhelmed by terms like ``set-builder''. They're only formal
