...
$$\displaystyle r = \sqrt{R^2 + z^2 - 2Rz\cos\theta},$$
...
$$\displaystyle \cos \varphi = \frac{z - R\cos\theta}{\sqrt{R^2 + z^2 - 2Rz\cos\theta}}$$

You then integrate over the surface area and get the integral,

$$\displaystyle E_z = \frac{1}{4\pi\epsilon_0} \int_0^{\pi}\int_0^{2\pi}\frac{\sigma R^2\sin\theta(z - R\cos\theta)}{(R^2 + z^2 - 2Rz\cos\theta)^{3/2}}d\theta d\phi.$$
