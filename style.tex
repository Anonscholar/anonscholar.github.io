...
\nonzeroparskip
\usepackage[right=10cm,left=2cm,bottom=1cm,top=1cm,marginparwidth=7.5cm,marginparsep=1cm,includeheadfoot,asymmetric]{geometry}
...
\newif\ifNoChapNumber
\newcommand\Vlines{%
\def\VL{\rule[-1cm]{1pt}{2.8cm}\hspace{1mm}\relax}
...
\makeevenhead{mystyle}{{\emph{\thechapter.\,\leftmark}}}{\hspace*{49em} \sffamily\thepage}{}
\makeoddhead{mystyle}{\emph{\rightmark}}{\hspace*{49em} \sffamily\thepage}{}
...
\renewcommand{\foottextfont}{\footnotesize\itshape}
...
\fi}
 ...
 \makeatletter
  ...
  {\small\scshape\figurename~\thefigure}}
\makeatother
