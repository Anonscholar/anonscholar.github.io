...
\nonzeroparskip
\usepackage[right=8cm,left=2cm,bottom=1in,top=1in,marginparwidth=5.5cm,marginparsep=.5cm,includeheadfoot,asymmetric]{geometry}
...
\makeevenhead{mystyle}{{\emph{\thechapter.\,\leftmark}}}{\hspace*{43em} \sffamily\thepage}{}
\makeoddhead{mystyle}{\emph{\rightmark}}{\hspace*{43em} \sffamily\thepage}{}
