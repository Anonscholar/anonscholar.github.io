...
\usepackage[top=1in,bottom=1in,left=2cm,right=4cm,marginparwidth=85pt]{geometry}
...
{\vskip15pt\llap{\makebox[3em]{{\bfseries\thecontentspage\hfill{\thecontentslabel}}}\hskip1em}
    \large\bfseries\vskip-\baselineskip\hspace{9em}\partname\, : \,}{}{}{}
\titlecontents{chapter}[0pt]
{\vskip15pt\llap{\makebox[3em]{{\bfseries\thecontentspage\hfill\thecontentslabel}}\hskip1em}
    \small\bfseries\vskip-\baselineskip}{}{}{}
\titlecontents*{section}[20pt]
{\upshape}{}{}
{\, {\bfseries\thecontentspage}}[][\ \textbullet\ ][]
...
{8pt}
{
    ...
    \vspace{2ex}%
    \begin{center}
     \pgfornament[scale=0.4]{79}\LARGE\bfseries\filcenter \enspace  #1 \enspace \pgfornament[scale=0.4]{78}
    \end{center}
}
...
\newcommand{\incfig}[1]{%
    ...
    \scalebox{.3}{\import{../figures/}{#1.pdf_tex}}
}
