...
\nonzeroparskip
\usepackage[right=7.5cm,left=2cm,bottom=1in,top=1in,marginparwidth=6cm,marginparsep=.5cm,asymmetric]{geometry}
...
\makeevenhead{mystyle}{{\sffamily\thepage}}{}{\emph{\thechapter.\,\leftmark}}
\makeoddhead{mystyle}{\emph{\rightmark}}{}{\sffamily\thepage}
