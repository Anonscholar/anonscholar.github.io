...
\usepackage[right=4.5cm,left=1.5cm,bottom=1in,top=1in,marginparwidth=4cm]{geometry}

\usepackage[activate={true,nocompatibility},factor=1100,stretch=10,shrink=10]{microtype} % better spacing
...
\makeevenhead{mystyle}{\bfseries\thepage}{}{\textbf{\color{TealBlue!70!black}\thechapter}\,: \leftmark}
\makeoddhead{mystyle}{\textbf{\color{TealBlue!70!black}\S}\,\rightmark}{}{\bfseries\thepage}
...
\NewDocumentCommand{\fncytitling}{s}{
