...
\begin{equation}
    \sum_{i}\sum_{j \ne i} \vec{f}_{ij} = \sum \vec{f}_{ij} + \vec{f}_{ji} = 0
\end{equation}
...
The vector \(\vec{R}\) locates the center of mass of the system. 

\begin{definition}
    The \vocab{center of mass} of the system is the position \(\vec{R}\) from origin, where,
    \begin{equation}
        \vec{R} \equiv \frac{\sum m_i \vec{r}_i}{\sum m_i}
    \end{equation}
\end{definition}

With the help of it, we can treat the dynamics of an extended system as if it were a particle of mass \(M\) located 
at its center of mass (com).
