...
\begin{marginfigure}
    \scalebox{1.6}{\incfig{transvectors}}
...
\begin{marginfigure}
    \centering
    \scalebox{1.6}{\incfig{scalarmultiplication}}
...
Since we're considering values of small \(\vartheta\), we may use the small angle approximation,
\(\sin(\vartheta) \approx \vartheta\). Therefore,

\begin{marginfigure}
    \centering
    \scalebox{2.02}{\incfig{timedev}}
...
This is a rather simple idea since \(\cos\vartheta \in [-1, 1]\). 
...
\begin{marginfigure}
    ...
    \caption{Angle bisector of \(2\vartheta\).}
\end{marginfigure}
