...
\begin{marginfigure}
    \centering
    \scalebox{1.5}{\incfig{vectproject1}}
...
\begin{marginfigure}
    \centering
    \scalebox{2}{\incfig{vectproject2}}
...
\begin{marginfigure}
    \centering
    \scalebox{1.8}{\incfig{reflectionvect}}
...
\begin{marginfigure}
    \centering
    \scalebox{1.7}{\incfig{anglebisect1}}
...
\begin{marginfigure}
    \centering
    \scalebox{2}{\incfig{anglebisect2}}
