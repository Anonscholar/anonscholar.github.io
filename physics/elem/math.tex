...
combination of other vectors, so we cannot write them in terms of the other vectors.
 Otherwise, we could have simply written the term \(\vec{e}_i\) as the linear combination of other vectors whenever we needed to use it.
...
In cartesian co-ordinates, or when using the orthogonal cartesian basis, we use the unit vectors along the three axes, \(x\), \(y\) and 
